...
class HomeTopChartsTab extends StatefulWidget {
  HomeTopChartsTab({Key key}) : super(key: key);

  @override
  _HomeTopChartsTabState createState() => _HomeTopChartsTabState();
}

class _HomeTopChartsTabState extends State<HomeTopChartsTab> {
  @override
